...
<p>
  <span style="font-size: 20px;">
    The Solana validator network continues to thrive. With respect to metrics
    including node count, consensus nodes (block-producing validators), Nakamoto
    coefficient, and node distribution and diversity, the Solana network
    improved significantly over the past year. It’s made several advancements in
    resiliency in this period, particularly at the validator client level.
  </span>
  <strong style="font-size: 20px;">
    <u>
      Today, Solana is one of the largest proof of stake networks in the world
      by node count, and one of the most distributed, as measured by Nakamoto
      Coefficient.
    </u>
  </strong>
</p>
