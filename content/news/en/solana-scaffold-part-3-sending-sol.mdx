...
topics: []
heroImage: >-
  https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fcc4aee157e2c404389094cbbeccb02ac
status: published
locale: en
seo:
...
![](/solana-scaffold-part-3-sending-sol/image-1.gif)
...
<p><span style="font-size: 20px;">Nothing's happening? Let's rewrite this with some error handling and connect it to our notify UI:</span></p>

<p><span style="font-size: 20px;">Result:</span></p>

![](/solana-scaffold-part-3-sending-sol/image-2.gif)
...
![](/solana-scaffold-part-3-sending-sol/image-3.jpg)
...
![](/solana-scaffold-part-3-sending-sol/image-4.jpg)

<p><span style="font-size: 20px;">The above image in code:</span></p>

<p><span style="font-size: 20px;">In our use case, when we wanted to send SOL, we only had one instruction in our transaction:</span></p>

<p><span style="font-size: 20px;">Wait, what instruction are you talking about? The solution is... not in the cookbook! Got you! We just have to right-click and go to definition in the code directly. Code is truth, always:</span></p>

![](/solana-scaffold-part-3-sending-sol/image-5.jpg)
...
![](/solana-scaffold-part-3-sending-sol/image-6.jpg)
...
<p><span style="font-size: 20px;">What is this&nbsp;</span>BasicsView<span style="font-size: 20px;">? It doesn't exist yet, so let's create it in&nbsp;</span>views/basics/index.tsx<span style="font-size: 20px;">. Inside it, is where we will display our&nbsp;</span>&lt;SendTransaction /&gt;<span style="font-size: 20px;">&nbsp;component.</span></p>

<p><span style="font-size: 20px;">Let's make our life easier with imports by adding&nbsp;</span>BasicsView<span style="font-size: 20px;">&nbsp;to&nbsp;</span>views/index.tsx<span style="font-size: 20px;">:</span></p>

<p><span style="font-size: 20px;">Also before we forget, let's make the link to our new page appear in our&nbsp;</span>components/AppBar.tsx<span style="font-size: 20px;">. Open&nbsp;</span>components/AppBar.tsx<span style="font-size: 20px;">&nbsp;(I am omitting the whole HTML to ease your eyes, look for&nbsp;</span>"Nav Links"<span style="font-size: 20px;">):</span></p>

<p><span style="font-size: 20px;">Finally, we can create&nbsp;</span>components/SendTransaction.tsx<span style="font-size: 20px;">:</span></p>
...
![](/solana-scaffold-part-3-sending-sol/image-7.jpg)
