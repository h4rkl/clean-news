...
<p>
  <span style="font-size: 20px;">
    Nothing's happening? Let's rewrite this with some error handling and connect
    it to our notify UI:
  </span>
</p>
...
<p>
  <span style="font-size: 20px;">The above image in code:</span>
</p>

<p>
  <span style="font-size: 20px;">
    In our use case, when we wanted to send SOL, we only had one instruction in
    our transaction:
  </span>
</p>
...
<p>
  <span style="font-size: 20px;">
    Wait, what instruction are you talking about? The solution is... not in the
    cookbook! Got you! We just have to right-click and go to definition in the
    code directly. Code is truth, always:
  </span>
</p>
...
<p>
  <span style="font-size: 20px;">What is this</span>BasicsView
  <span style="font-size: 20px;">
    ? It doesn't exist yet, so let's create it in
  </span>
  views/basics/index.tsx
  <span style="font-size: 20px;">
    . Inside it, is where we will display our
  </span>
  &lt;SendTransaction /&gt;<span style="font-size: 20px;">component.</span>
</p>

<p>
  <span style="font-size: 20px;">
    Let's make our life easier with imports by adding
  </span>
  BasicsView<span style="font-size: 20px;">to</span>views/index.tsx
  <span style="font-size: 20px;">:</span>
</p>

<p>
  <span style="font-size: 20px;">
    Also before we forget, let's make the link to our new page appear in our
  </span>
  components/AppBar.tsx<span style="font-size: 20px;">. Open</span>
  components/AppBar.tsx
  <span style="font-size: 20px;">
    (I am omitting the whole HTML to ease your eyes, look for
  </span>
  "Nav Links"<span style="font-size: 20px;">):</span>
</p>

<p>
  <span style="font-size: 20px;">Finally, we can create</span>
  components/SendTransaction.tsx<span style="font-size: 20px;">:</span>
</p>
