...
topics: []
heroImage: >-
  https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F1b320ed6b08640549af12d7d049ec79d
status: published
locale: en
seo:
  title: The State of Solana at Breakpoint 2024
...
<BuilderBlock name="Content Editor" options={{
  "callToAction": {
    ...
    "headline": {
      "@type": "@builder.io/core:LocalizedValue",
      "Default": "Take This Report With You"
    },
    "description": {
      "@type": "@builder.io/core:LocalizedValue",
      "Default": "Get a printable version of the State of Solana at Breakpoint 2024."
    }
  },
  "tocHeadline": {
    "@type": "@builder.io/core:LocalizedValue",
...
![](/state-of-solana-breakpoint-2024/image-1.png)
...
![](/state-of-solana-breakpoint-2024/image-2.png)
...
![](/state-of-solana-breakpoint-2024/image-3.png)
...
![](/state-of-solana-breakpoint-2024/image-4.png)
...
![](/state-of-solana-breakpoint-2024/image-5.png)
...
![](/state-of-solana-breakpoint-2024/image-6.png)
...
![](/state-of-solana-breakpoint-2024/image-7.png)
...
![](/state-of-solana-breakpoint-2024/image-8.png)
...
![](/state-of-solana-breakpoint-2024/image-9.png)
...
![](/state-of-solana-breakpoint-2024/image-10.png)
...
![](/state-of-solana-breakpoint-2024/image-11.png)
...
![](/state-of-solana-breakpoint-2024/image-12.png)
...
![](/state-of-solana-breakpoint-2024/image-13.png)
...
![](/state-of-solana-breakpoint-2024/image-14.png)
...
![](/state-of-solana-breakpoint-2024/image-15.jpg)
...
![](/state-of-solana-breakpoint-2024/image-16.png)
...
![](/state-of-solana-breakpoint-2024/image-17.png)
...
![](/state-of-solana-breakpoint-2024/image-18.png)
...
Interest in Bitcoin programmability has grown in the past year, with high-volume Ordinals trading, private funding into Bitcoin layers, and discussion around network upgrades like op\_cat. Historically, Bitcoin programmability has largely revolved around BTC itself – bridging BTC to other smart contract platforms. 
...
<BuilderBlock name="Switchback" options={{
  ...
  "image": {
    ...
    "src": "https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F868b363231274d8995b05dc520be6232"
  },
  "eyebrow": {
    "@type": "@builder.io/core:LocalizedValue",
    "Default": ""
  ...
  "body": {
    "@type": "@builder.io/core:LocalizedValue",
    "Default": "\u003cp>Sign up for the Letter to the Solana Ecosystem to keep up with the latest news.\u003c/p>"
  },
  "placeholder": {
    "@type": "@builder.io/core:LocalizedValue",
    "Default": "Share your email here!"
  },
  "emailError": {
    "@type": "@builder.io/core:LocalizedValue",
    "Default": "Please use a valid email."
  },
  "submitError": {
    "@type": "@builder.io/core:LocalizedValue",
  ...
  "successMessge": {
    "@type": "@builder.io/core:LocalizedValue",
    "Default": "Success! Thanks for joining!"
  },
  "newsLetter": true,
  "formId": "c2fea3ca-b535-4e6b-baf3-526f896333d0"
}}>
