...
![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-1.jpg)
...
![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-2.jpg)
...
![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-3.jpg)
...
![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-4.jpg)
...
![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-5.png)

<p><span style="font-size: 20px;">While the Accounts database is in RAM, we see throughput that matches RAM access times, while scaling with the number of available cores. At 10m accounts, the database no longer fits in RAM. However, we still see performance near 1m in reads or writes per second on a single SSD.</span></p>

![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-6.jpg)
...
![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-7.jpg)

![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-8.jpg)

![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-9.jpg)

![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-10.jpg)

![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-11.jpg)

![](/cloudbreak---solana-s-horizontally-scaled-state-architecture/image-12.jpg)
