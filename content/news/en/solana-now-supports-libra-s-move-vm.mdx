...
topics: []
heroImage: >-
  https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F9fb2e7d2afc543a0b20002ff58983206
status: published
locale: en
seo:
  title: Solana Now Supports Libra’s Move VM
...
![](/solana-now-supports-libra-s-move-vm/image-1.png)
...
![](/solana-now-supports-libra-s-move-vm/image-2.jpg)
...
![](/solana-now-supports-libra-s-move-vm/image-3.jpg)

Benchmarking for the Move VM on Solana

As you can see, the total execution time is 684us, and 605us of that is spent in the \`vm\_execute\` function, which handles the bytecode interpreter. This confirmed our expectations. We consider the results of this benchmarking to be truly remarkable because Sealevel can scale parallel execution of transactions across as many CPU cores as are available to the validator.

Solana native programs take 1us \`execute::vm\_execute,\` since the instructions are native x86. MoveVM is nearly 700x slower than our native Solana programs, and at this speed, we are able to demonstrate how well Sealevel handles CPUs horizontal scaling.
...
![](/solana-now-supports-libra-s-move-vm/image-4.jpg)
...
![](/solana-now-supports-libra-s-move-vm/image-5.jpg)

![](/solana-now-supports-libra-s-move-vm/image-6.jpg)

![](/solana-now-supports-libra-s-move-vm/image-7.jpg)

![](/solana-now-supports-libra-s-move-vm/image-8.jpg)

![](/solana-now-supports-libra-s-move-vm/image-9.jpg)

![](/solana-now-supports-libra-s-move-vm/image-10.jpg)
