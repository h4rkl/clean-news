...
<p>
  <span style="font-size: 20px;">
    To accelerate the already rapid growth of the ecosystem, the Solana
    Foundation recently teamed up with Serum, a leading project in Solana’s
    ecosystem, to host a virtual&nbsp;
  </span>
  <a
    href="https://solana.com/defi?ref=solana.ghost.io"
  ...
  <span style="font-size: 20px;">
    . The event brought together crypto pioneers, popular DeFi projects, and
    builders from around the world for two weeks of hacking on Solana and Serum.
  </span>
</p>
...
<iframe
  width="200"
  height="113"
  src="https://www.youtube.com/embed/yFexFkMLEBY?feature=oembed"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowfullscreen=""
></iframe>
