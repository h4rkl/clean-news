...
topics: []
heroImage: >-
  https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fa6225b5423aa493893522ac30496fce7
status: published
locale: en
seo:
      ...
      "blocks": [
        {
          ...
          "@version": 2,
          "id": "builder-7c779937d6474b0ea713c33e54a10a1b",
          "meta": {
            "previousId": "builder-9a5fb81f60f84ee688219fd257afa6dc"
          },
          "component": {
            "name": "Copy",
            "options": {
              "rawHtml": "\u003cp>While traditional loyalty programs unlock rewards for frequent customers, doing so on the blockchain gives users an advantage. Rewards that a customer earns are first and foremost owned by the customer themselves — no need to worry about lost physical cards or an app shutting down. This also means that users can do what they want with their rewards — they can redeem them, hold onto them, or even sell them on the open market.\u003c/p>\u003cp>Building on the blockchain could also unlock \u003cstrong>interoperability,\u003c/strong> or the ability for users to interact with other programs using the same chain without any friction — eventually opening up new benefits for Boba Guys customers beyond a free drink. But while interoperability as a concept exists across blockchain networks, Solana has an advantage in that it operates in a single, global state — not as separate layers or networks. That means that any loyalty program built on Solana has a much broader ecosystem to interact with, from NFT projects to real world infrastructure and more. The opportunities are endless.\u003c/p>"
            }
          },
          "responsiveStyles": {
            "large": {
      ...
      "blocks": [
        {
          "@type": "@builder.io/sdk:Element",
          "@version": 2,
          "id": "builder-6cc98acf91e24bb3893318da9c9190d0",
          "meta": {
            "previousId": "builder-b0ee117e171249c3badceaf772b21181"
          },
          "component": {
            "name": "Image",
            "options": {
              "image": "https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=498",
              ...
              "sizes": "(max-width: 638px) 79vw, (max-width: 998px) 47vw, 36vw",
              "height": 1333,
              "width": 2000,
              "srcset": "https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=100 100w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=200 200w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=400 400w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=800 800w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=1200 1200w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=1600 1600w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=2000 2000w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=498 498w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2Fe5e3ee93559f43288dad93976e53b826?width=460 460w"
            }
          },
          "responsiveStyles": {
            "large": {
        ...
        },
        {
          "@type": "@builder.io/sdk:Element",
          "@version": 2,
          "id": "builder-203fdf9b2c754573b9e7aa5e1f3dd998",
          "meta": {
            "previousId": "builder-29d26c70b0f541cfa709e5bbe412c9fe"
          },
          "component": {
            "name": "Copy",
            "options": {
              "rawHtml": "\u003cp>\n  \u003cem style=\"color: rgb(155, 155, 155);\"\n    >Drinks from Boba Guys at an event during NFT NYC, 2023. Photo courtesy of\n    the Solana Foundation.\u003c/em\n  >\n\u003c/p>\n"
            }
          },
          "responsiveStyles": {
            "large": {
      ...
      "blocks": [
        {
          "@type": "@builder.io/sdk:Element",
          "@version": 2,
          "id": "builder-829e4e89e098468ab07d5ebb7165e56a",
          "meta": {
            "transformed.rawHtml": "localized",
            "localizedTextInputs": [
              "rawHtml"
            ],
            "previousId": "builder-07ed64768d584f029a8d79f7f85ab1e6"
          },
          "component": {
            "name": "Copy",
            "options": {
              "rawHtml": {
                ...
                "Default": "\u003cp>“Because we built a Square integration, we were able to onboard customers right at the register,” Chen said in a recent interview with the Solana Foundation. Rather than asking users to navigate an unwieldy, modern web3 onboarding process, customers can join the program with a simple QR code scan during their transaction.&nbsp;\u003c/p>\u003cp>Surprisingly, Chen reports this approach appeals to customers of all ages and is not exclusive to digitally native Gen Z shoppers.&nbsp;\u003c/p>\u003cp>\"The most eye-opening thing for us has been successfully attracting guests of all ages,” he said. “It's one thing to engage with Gen Z, who intuitively understand technology, but we're a cafe serving a diverse clientele. Some are tech-savvy, others are not. The real test was introducing blockchain technology in a way that's almost invisible to our customers.”\u003c/p>"
              }
            }
          },
          "responsiveStyles": {
      ...
      "blocks": [
        {
          "@type": "@builder.io/sdk:Element",
          "@version": 2,
          "id": "builder-89fc669198ca40bdaf2e670bfc0da6e0",
          "meta": {
            "previousId": "builder-b0ee117e171249c3badceaf772b21181"
          },
          "component": {
            "name": "Image",
            "options": {
              "image": "https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=498",
              "backgroundSize": "cover",
              "backgroundPosition": "center",
              "lazy": false,
              "fitContent": true,
              ...
              "height": 1333,
              "width": 2000,
              "srcset": "https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=100 100w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=200 200w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=400 400w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=800 800w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=1200 1200w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=1600 1600w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=2000 2000w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=498 498w, https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F20ed872d52c34771af9e4fede0a3621c?width=460 460w"
            }
          },
          "responsiveStyles": {
            "large": {
        ...
        },
        {
          "@type": "@builder.io/sdk:Element",
          "@version": 2,
          "id": "builder-5af25f73574945a09e4a3027b2873add",
          "meta": {
            "previousId": "builder-606d2630135f4d37997b8e27eec15b4e"
          },
          "component": {
            "name": "Copy",
            "options": {
              "rawHtml": "\u003cp>\n  \u003cem style=\"color: rgb(155, 155, 155);\"\n    >A customer using a QR code to purchase drinks from Boba Guys at an NFT NYC\n    event, 2023. Photo courtesy of the Solana Foundation.\u003c/em\n  >\n\u003c/p>\n"
            }
          },
          "responsiveStyles": {
            "large": {
...
<BuilderBlock name="Feature Highlight" options={{
  "eyebrow": "",
  "headline": "Boba Guys 'Passport' Pilot Program Results",
  "body": "As of Nov. 1, 2023:",
  "cards": [
    {
      "feature": "67%",
      "body": "Increase in monthly visits, per customer"
    },
    {
      "feature": "65%",
      "body": "Increase in monthly spending, per customer"
    },
    {
      "feature": "800%",
      "body": "ROI"
...
<BuilderBlock name="Conversion Panel" options={{
  "variant": "centered",
  "heading": "Frictionless — and permissionless.",
  "body": "Take advantage of the suite of Solana tooling to build better payments rails.",
  "buttons": [
    {
      "label": "Learn more",
      "hierarchy": "primary",
