...
<ul>
  <li>
    ...
    : In March 2023, the validator ecosystem began planning and convening consistent
    calls for the validator community to share notes and best practices.
  </li>
  <li>
    ...
    first ever Block 0 in Amsterdam on Oct. 30, 2023. This is an entirely community-run
    event to discuss the evolution of the Solana network and reinforce social ties.
  </li>
</ul>
<p>
