...
description: >-
  ...
  This post originally appeared on August 23rd on Packy McCormick's

  [https://twitter.com/packyM] Not Boring

  [https://www.notboring.co/p/solana-summer], and was reprinted with
  permission. 
  ...
  Thus far, I’ve only done Sponsored Deep Dives on Thursdays, never Monday. As a

  reminder, you can read how I choose what companies to write Sponsored Deep
  Dives
...
seo:
  ...
  description: >-
    ...
    Thus far, I’ve only done Sponsored Deep Dives on Thursdays, never Monday. As
    a
  ...
  noFollow: false
  openGraph:
    ogTitle: Solana Summer
    ogUrl: https://www.solana.com/blog/solana-summer
    ogDescription: >-
      The $21B Blockchain and the Arrow of Time
      ...
      We’re breaking some Not Boring rules here today, and I want to explain
      why.


      Thus far, I’ve only done Sponsored Deep Dives on Thursdays, never Monday.
      As a
...
![](/solana-summer/image-3.jpg)

<p><span style="font-size: 20px;">When the mint finally launched, I was locked out, stuck looking at this screen no matter how many ways I tried to get around it.</span></p>

![](/solana-summer/image-4.jpg)
...
<BuilderBlock name="VideosSection" options={{}}>
...
![](/solana-summer/image-12.gif)

<p><span style="font-size: 20px;">The black squares represent transactions I put through by smashing my space bar. When they turn green, they’re confirmed. In 15 seconds, I sent 80 real transactions through Solana.</span></p>

![](/solana-summer/image-13.jpg)
...
<p><span style="font-size: 20px;">Already, Saber has $621M in Total Value Locked (TVL), the most commonly used measure of activity in DeFi. That ranks third among all Solana projects, including Solana itself.</span></p>

![](/solana-summer/image-19.jpg)
