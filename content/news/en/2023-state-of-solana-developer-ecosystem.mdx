...
topics: []
heroImage: >-
  /2023-state-of-solana-developer-ecosystem/4a609d00f4674a26a32fc621e7552511.jpg
status: published
locale: en
seo:
  title: The 2023 State of the Solana Developer Ecosystem
...
<p style="text-indent: 1em;">
  <em>Source: Solana Hacker House Registrations</em>
</p>
<h3>Developer growth</h3>
<p>
  Although the Solana ecosystem is relatively new — Solana mainnet beta went
  live in March 2020 —&nbsp; its developer ecosystem has{" "}
  <a
    href="https://www.developerreport.com/developer-report"
    rel="noopener noreferrer"
    target="_blank"
  >
    grown to the second largest ecosystem in total monthly active developers
  </a>
  . This growth is due to many different factors and it is hard to pinpoint what
  led to the majority of developers joining. Since the launch of mainnet beta,
  the Solana Foundation has either run or funded a variety of initiatives with
  the core objective of growing the developer ecosystem. A few key initiatives
  include Solana Hackathons, Solana Hacker Houses, Breakpoint, educational
  bootcamps, and sponsored university events. There have been a variety of
  ecosystem-led groups that have contributed to this growth as well, such as
  SuperteamDAO, mtnDAO, Metcamp, and Gen3.
</p>
<p>
  We expect the Solana Hackathons to be a top indicator for the health of the
  developer ecosystem. There have been eight Solana Foundation-sponsored
  hackathons since 2020. Over the past three years, more than 3000 projects have
  launched and over $600 million in funding has been raised for projects
  submitted to the hackathons. With each hackathon, the number of project
  submissions has increased. The most recent hackathon, Solana Hyperdrive, had
...
| TS/JS    | \n [Available\n ](https://github.com/solana-labs/solana-web3.js) | Not Available                                      | High(69% total)  |
| Python   | \n [Available\n ](https://github.com/michaelhly/solana-py)       | \n [Seahorse](https://www.seahorse.dev/)\n         | High(52% total)  |
| Java     | \n [Available\n ](https://github.com/skynetcap/solanaj)          | Not Available                                      | High(49% total)  |
| PHP      | \n [Available\n ](https://github.com/verze-app/solana-php-sdk)   |                                                    | High(32% total)  |
| C++      | \n [Available\n ](https://github.com/mschneider/solcpp)          | Native                                             | 23%              |
| C#       | \n [Available\n ](https://github.com/bmresearch/Solnet)          | Not Available                                      | 21%              |
| C        | Not Available                                                    | Native                                             | 19%              |
| GoLang   | \n [Available\n ](https://github.com/gagliardetto/solana-go)     | \n [Available](https://sol.goscript.dev/)\n        | 17%              |
| Kotlin   | \n Available\n                                                   | Not Available                                      | 14%              |
| Dart     | \n Available\n                                                   |                                                    | 8%               |
...
| Next.js | Available\n               | Available                                                 | 17%    |
| Vue.js  | Available; Not Maintained | \n Available; Not Maintained\n                            | 17%    |
| Laravel | \n Not Available\n        | Not Available                                             | 8%     |
| Svelte  | \n Not Available\n        | Not Available                                             | 6%     |
...
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------- |
| [HardHat](https://hardhat.org/)                                                                               | Testing framework with local network\n            | [Solana Test Validator](https://docs.solana.com/developing/test-validator)                                 | High             |
...
| Ethers, Wagmi                                                                                                 | Frontend framework\n                              | [@solana/web.js](https://www.npmjs.com/package/@solana/web3.js)                                            | High             |
| Remix                                                                                                         | Web-based IDE\n                                   | [Solana Playground](https://beta.solpg.io/)                                                                | High             |
| Debugging                                                                                                     | Breakpoint debugger\n                             | [Bokken](https://github.com/Blade-Labs-Corp/bokken),                                                       |
...
| [VSCode Extension](https://marketplace.visualstudio.com/items?itemName=JuanBlanco.solidity)                   | Extension to speed up Solidity development\n      | [Solana Playground Extension](https://marketplace.visualstudio.com/items?itemName=solana-playground.solpg) | Medium           |
  ...
  "cards": [
    {
      ...
      "backgroundImage": {
        "src": "/2023-state-of-solana-developer-ecosystem/dfb1773873354d118d134beca2334288.png"
      },
      "callToAction": {
