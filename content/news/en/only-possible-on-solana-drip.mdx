...
topics: []
heroImage: >-
  https://cdn.builder.io/api/v1/image/assets%2Fce0c7323a97a4d91bd0baa7490ec9139%2F3c06c6410aac457b876b3eee1625945f
status: published
locale: en
seo:
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/XAND6G6dW2c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<BuilderBlock name="Rich Text Quote" options={{
  ...
  "quote": {
    "@type": "@builder.io/core:LocalizedValue",
    "Default": "\u003cp>Compression basically allowed DRiP to exist. Without Solana compression, DRiP isn't possible.\u003c/p>"
  }
}}>
...
<BuilderBlock name="Switchback" options={{
  ...
  "body": {
    "@type": "@builder.io/core:LocalizedValue",
    "Default": "\u003cp>See how teams like Helium, Decaf, and more are taking advantage of the Solana tech stack to build a fast, secure, scalable, and user-friendly future.\u003c/p>"
  },
  "placeholder": {
    "@type": "@builder.io/core:LocalizedValue",
    "Default": ""
