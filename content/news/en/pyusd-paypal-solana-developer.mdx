...
<h2>
  <strong>Integrating PYUSD</strong>
</h2>
<p>The PYUSD Mint Address is:</p>
<p>
  <code>
    <strong>2b1kV6DkPAnxd5ixfnxCpjxmKwqjjaYmCZfHsFu24GXo</strong>
  </code>
</p>
<p>
  This address uniquely identifies the PYUSD token on the Solana network and
  should be used to integrate PYUSD into your application. You can inspect the
  details of the mint account on the{" "}
  <a
...
<p>
  To learn more about how tokens are represented on the Solana network, visit
  the{" "}
  <a
    href="https://solana.com/docs/core/tokens"
    rel="noopener noreferrer"
    target="_blank"
  >
    Tokens on Solana
